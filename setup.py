...
solid_node_version = "0.0.1"

try:
    solid_node_version = str(version.parse(os.getenv("SOLID_NODE_VERSION")))
except Exception:
    pass
...
setup(
    ...
    url="https://github.com/LibreSolid/solid_node",
    version=solid_node_version,
    zip_safe=False,
)
